...
CREATE TABLE users (
    ...
    job_seeker_type         NVARCHAR(50) NULL,
    cccd_number             NVARCHAR(20) NULL,
    cccd_front_url          NVARCHAR(1000) NULL,
    cccd_back_url           NVARCHAR(1000) NULL,
    certificate_urls        NVARCHAR(MAX) NULL,
    
    experience_years        FLOAT NULL,
    education_level         NVARCHAR(100) NULL,
    portfolio_url           NVARCHAR(1000) NULL,
    is_freelancer           BIT DEFAULT 0,
    available_hours         NVARCHAR(200) NULL,
    service_areas           NVARCHAR(500) NULL,
...
CREATE TABLE employer_profiles (
    ...
    employer_type           NVARCHAR(50) NULL,
    manager_name            NVARCHAR(200) NULL,
    manager_phone           NVARCHAR(50) NULL,
    business_license_url    NVARCHAR(1000) NULL,
    facility_images         NVARCHAR(MAX) NULL,
    
    representative_name     NVARCHAR(200) NULL,
